...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "GET #edit" do
    ...
    it "assigns question to be updated to @question" do
      get :edit, {id: my_q.id}
      qi = assigns(:question)
      expect(qi.id).to eq my_q.id
      expect(qi.title).to eq my_q.title
      expect(qi.body).to eq my_q.body
    end
  end

  describe "POST create" do
    it "increases the number Question by 1" do
  ...
  describe "PUT update" do
    it "updates question with expected attributes" do
      ...
      expect(updated_q.resolved).to be true
    end
